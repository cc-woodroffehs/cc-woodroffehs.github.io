...
(function(root, factory) {
  ...
  function handleTweets(tweets){
    if (customCallbackFunction === null) {
      ...
      while(n < x) {
        html += '<div class="col s12 m6 l6"><div class="card">' + tweets[n] + '</div></div>';
        n++;
      }
      html += '</div>';
      ...
      if (dataOnly) {
        ...
        while (n < x) {
          ...
          if (parseLinks) {
            ...
            op += '<div class="col s12"><div class="card"></div class="card-content>"' + strip(tweets[n].innerHTML) + '</div></div></div>';
            if (printTime) {
              if (permalinks) {
